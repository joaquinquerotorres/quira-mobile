...
- Sin thumbnail: chip **Media** debajo de la fila de disponibilidad/fecha (no en pills ni en footer). En pendientes sin pro, el footer muestra **«Esperando propuestas»** (el cliente no busca profesional; espera pujas).
