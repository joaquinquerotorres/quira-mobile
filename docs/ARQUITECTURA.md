...
- **Vídeo hacia `/predict`:** la app intenta **re-codificar** en cliente cuando hay **datos móviles** o red **lenta**, o cuando el fichero supera **~6 MB** decodificados (aunque el sistema reporte Wi‑Fi: útil con Wi‑Fi lenta o clips cortos pero muy pesados). Si la compresión falla o no aplica (p. ej. vídeo **más largo de ~5 minutos**), se envía el original. La publicación (paso 2) sigue subiendo el vídeo **original** del paso 1 al bucket.
- Para el lanzamiento:
